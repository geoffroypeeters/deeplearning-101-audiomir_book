...
### **1. Diffusion Model Architecture (`DiffusionUnet` Class)**
...
### **2. Noise Addition and Training Objective (`RectifiedFlows` Class)**
...
### **4. Method Adopted: Rectified Flow with ODE-Based Sampling**
